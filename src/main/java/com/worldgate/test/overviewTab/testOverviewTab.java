...
public class testOverviewTab {
	...
	public void i_have_landed_on_the_overview_tab() throws Throwable {
		...
		Thread.sleep(5000);
		assertTrue("Browser should be on the overview page, but it isn't!", 
				wd.getCurrentUrl().equals("https://dev.assignforce.revaturelabs.com/home"));
	}
...
//		}
		assertTrue("Batches should be in ascending order according to start date, but they aren't!", 
				sortTestDate(7, "ascending"));
	}
	
	@Given("^I am on the overview tab$")
	public void i_am_on_the_overview_tab() throws Throwable {
		assertTrue("Browser should be on the overview tab, but it isn't!", 
	...
	public void batches_should_be_in_ascending_order_according_to_room() throws Throwable {
		assertTrue("Batches should be in ascending order according to room number, but they aren't!",
				sortTestInt(6, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_room() throws Throwable {
		assertTrue("Batches should be in descending order according to room number, but they aren't!",
				sortTestInt(6, "descending"));
	}
