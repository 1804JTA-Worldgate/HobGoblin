...
public class testBatchesTab {
	...
	public void browser_should_land_on_the_batches_page() throws Throwable {
	    Thread.sleep(5000);
	    assertTrue("Browser should be on the batches page, but it isn't!",
	    		wd.getCurrentUrl().equals("https://dev.assignforce.revaturelabs.com/batches"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_start_date() throws Throwable {
		assertTrue("Batches should be in descending order according to start date, but they aren't!", 
				sortTestDate(9, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_start_date() throws Throwable {
		assertTrue("Batches should be in ascending order according to start date, but they aren't!", 
				sortTestDate(9, "ascending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_end_date() throws Throwable {
		assertTrue("Batches should be in ascending order according to end date, but they aren't!", 
				sortTestDate(10, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_end_date() throws Throwable {
		assertTrue("Batches should be in descending order according to end date, but they aren't!", 
				sortTestDate(10, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_room() throws Throwable {
		assertTrue("Batches should be in ascending order according to room, but they aren't!", 
				sortTestInt(8, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_room() throws Throwable {
		assertTrue("Batches should be in descending order according to room, but they aren't!", 
				sortTestInt(8, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_building() throws Throwable {
		assertTrue("Batches should be in ascending order according to building, but they aren't!", 
				sortTestString(7, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_building() throws Throwable {
		assertTrue("Batches should be in descending order according to building, but they aren't!", 
				sortTestString(7, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_location() throws Throwable {
		assertTrue("Batches should be in ascending order according to location, but they aren't!", 
				sortTestString(6, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_location() throws Throwable {
		assertTrue("Batches should be in descending order according to location, but they aren't!", 
				sortTestString(6, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_trainer_cotrainer() throws Throwable {
		assertTrue("Batches should be in ascending order according to trainer/cotrainer, but they aren't!", 
				sortTestString(5, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_trainer_cotrainer() throws Throwable {
		assertTrue("Batches should be in descending order according to trainer/cotrainer, but they aren't!", 
				sortTestString(5, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_focus() throws Throwable {
		assertTrue("Batches should be in ascending order according to focus, but they aren't!", 
				sortTestString(4, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_focus() throws Throwable {
		assertTrue("Batches should be in descending order according to focus, but they aren't!", 
				sortTestString(4, "descending"));
	}
	...
	public void batches_should_be_in_ascending_order_according_to_curriculum() throws Throwable {
		assertTrue("Batches should be in ascending order according to curriculum, but they aren't!", 
				sortTestString(3, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_curriculum() throws Throwable {
		assertTrue("Batches should be in descending order according to curriculum, but they aren't!", 
				sortTestString(3, "descending"));
	...
	public void batches_should_be_in_ascending_order_according_to_name() throws Throwable {
		assertTrue("Batches should be in ascending order according to name, but they aren't!", 
				sortTestString(2, "ascending"));
	}
	...
	public void batches_should_be_in_descending_order_according_to_name() throws Throwable {
		assertTrue("Batches should be in descending order according to name, but they aren't!", 
				sortTestString(2, "descending"));
